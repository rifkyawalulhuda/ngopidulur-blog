                                    ...
                                    <Teleport to="body">
                                        <div v-if="openDropdownId === item.id" :style="dropdownStyle" class="z-[9999] w-44 rounded-2xl border border-gray-200 bg-white p-2 shadow-theme-lg dark:border-gray-800 dark:bg-gray-900" data-dropdown-actions>
                                            <div class="space-y-1" role="menu">
                                                ...
                                                <button @click="emit('prompt-delete', 'category', item); closeDropdown()" class="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left text-sm font-medium text-red-700 transition hover:bg-red-50 dark:text-red-300 dark:hover:bg-red-500/10" role="menuitem">
